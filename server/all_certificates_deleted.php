...
<head>
    ...
    <title>Удаленные сертификаты</title>
...
function restoreCertificate(certificateId) {
            if (confirm("Вы действительно хотите восстановить этот сертификат?")) {
                ...
                xhttp.open("GET", "restore_certificate.php?id=" + certificateId, true);
                xhttp.send();
            }
        }
function loadMoreCertificates() {
    page++;
    var url = "get_certificates_remove.php?page=" + page;
    var xhttp = new XMLHttpRequest();
...
<!--<div class="search-container">
    ...
    echo "<h1>Удаленные сертификаты</h1>";
